...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/data/Train_dataset/vid/crop511'          # VID dataset path
...
__C.DATASET.YOUTUBEBB.ROOT = '/data/Train_dataset/yt_bb/crop511'  # YOUTUBEBB dataset path
__C.DATASET.YOUTUBEBB.ANNO = '/data/Train_dataset/yt_bb/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = 100000  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/data/Train_dataset/coco/crop511'         # COCO dataset path
__C.DATASET.COCO.ANNO = '/data/Train_dataset/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/data/Train_dataset/det/crop511'           # DET dataset path
...
__C.DATASET.LaSOT.ROOT = '/data/Train_dataset/lasot/crop511'         # LaSOT dataset path
...
__C.DATASET.VIDEOS_PER_EPOCH = 300000 #600000
# ------------------------------------------------------------------------ #
# Backbone options
# ------------------------------------------------------------------------ #
__C.BACKBONE = CN()
...
__C.HP_SEARCH.UAVTrack112 = [0.40, 0.25, 0.445]

__C.HP_SEARCH.UAV123_20L = [0.40, 0.25, 0.445]

__C.HP_SEARCH.UAVDT = [0.40, 0.25, 0.445]
