...
from siamban.models.neck.tran import Transformer
...
class Adjust_Transformer(nn.Module):
    def __init__(self, channels=256):
        ...
        self.transformer = Transformer(channels, nhead = 8, num_encoder_layers = cfg.TRAIN.NUM_ENCODER, num_decoder_layers = 0)
